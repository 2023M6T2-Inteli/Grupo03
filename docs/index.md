...
#### **Subscriber:**
  ...
  1 - Importação dos pacotes e métodos necessários para o tratamento e rederização do output do modelo:
    ...
    ```
  2 - Definição da classe "Streaming" que traz a lógica de receber os dados, tratá-los, fazer o input deles para a análise por parte do modelo e rederização do resultado:
